          ...
          {sortedMPs.map((mp, idx) => (
            <div key={idx} className="bg-white border border-slate-200 rounded-lg p-4 flex flex-col hover:shadow-md transition-shadow">
              <div className="flex justify-between items-start mb-2">
                ...
                <div className={`flex items-center gap-1 text-sm font-bold px-2 py-1 rounded ${mp.poshScore > 80 ? 'bg-purple-100 text-purple-700' :
              ...
              <p className="text-sm text-slate-600 italic mt-2">"{mp.poshAnalysis}"</p>
            </div>
          ))}
        </div>
      </div>
